...
function SourceNote({ source }: { source: LearningRecordSource }) {
  return source === "synthetic_experience"
    ? <span className="record-source synthetic">示例体验内容</span>
